...
interface HeroVersicherungProps {
    onCtaClick: () => void;
}

export const HeroVersicherung = ({ onCtaClick }: HeroVersicherungProps) => {
    return (
            ...
            <div className="container mx-auto px-4 max-w-7xl w-full">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto slide-up">
                        Von der automatisierten Schadensaufnahme bis zur KI-basierten Polizzen-Analyse: Maximieren Sie Ihre Abschlussrate und minimieren Sie den Verwaltungsaufwand.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroVersicherung")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroVersicherung");
                                onCtaClick();
                            }}
                        >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-12 fade-in">
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground mt-2">Schadens-Assistent</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold text-primary">Sekunden</div>
                            <div className="text-sm text-muted-foreground mt-2">Polizzen-Check</div>
                        </div>
                        <div className="col-span-2 md:col-span-1">
                            <div className="text-4xl md:text-5xl font-bold text-primary">+30%</div>
                            <div className="text-sm text-muted-foreground mt-2">Mehr Abschlüsse</div>
                        </div>
                    </div>
                </div>
            </div>

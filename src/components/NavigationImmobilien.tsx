...
export const NavigationImmobilien = () => {
    ...
    const menuItems = [
        { label: "Probleme", href: "/ki-loesungen-immobilienmakler#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-immobilienmakler#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-immobilienmakler#ueber-uns", hasDropdown: false },
        { label: "Referenzen", href: "/ki-loesungen-immobilienmakler#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-immobilienmakler#faq", hasDropdown: false },
    ];

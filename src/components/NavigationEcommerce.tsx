...
export const NavigationEcommerce = () => {
    ...
    const menuItems = [
        { label: "Engpässe", href: "/ki-loesungen-ecommerce#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-ecommerce#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-ecommerce#ueber-uns", hasDropdown: false },
        { label: "Feedback", href: "/ki-loesungen-ecommerce#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-ecommerce#faq", hasDropdown: false },
    ];

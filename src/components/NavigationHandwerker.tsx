...
export const NavigationHandwerker = () => {
    ...
    const menuItems = [
        { label: "Probleme", href: "/ki-loesungen-handwerker#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-handwerker#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-handwerker#ueber-uns", hasDropdown: false },
        { label: "Referenzen", href: "/ki-loesungen-handwerker#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-handwerker#faq", hasDropdown: false },
    ];

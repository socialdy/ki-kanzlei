...
export const NavigationFitness = () => {
    ...
    const menuItems = [
        { label: "Probleme", href: "/ki-loesungen-fitness#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-fitness#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-fitness#ueber-uns", hasDropdown: false },
        { label: "Referenzen", href: "/ki-loesungen-fitness#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-fitness#faq", hasDropdown: false },
    ];

...
export const NavigationHausverwaltung = () => {
    ...
    const menuItems = [
        { label: "Probleme", href: "/ki-loesungen-hausverwaltung#probleme" },
        { label: "Lösungen", href: "/ki-loesungen-hausverwaltung#loesungen" },
        { label: "Über uns", href: "/ki-loesungen-hausverwaltung#ueber-uns" },
                        ...
                        <div className="hidden lg:flex items-center gap-2 xl:gap-8">
                            {menuItems.map((item) => (
                                <Link
                                    ...
                                    to={item.href}
                                    onClick={(e: any) => {
                                        trackLinkClick(item.label, "NavigationHausverwaltung");

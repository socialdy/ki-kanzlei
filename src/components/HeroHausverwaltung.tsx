...
interface HeroHausverwaltungProps {
    onCtaClick: () => void;
}

export const HeroHausverwaltung = ({ onCtaClick }: HeroHausverwaltungProps) => {
    return (
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <div className="inline-block slide-up mt-8 md:mt-0">
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-medium">
                            Ihr österreichischer KI‑Partner für Hausverwaltungen
                        </span>
                    </div>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight slide-up">
                        KI Lösungen für <span className="text-primary">Hausverwaltungen</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto slide-up">
                        Von der 24/7 Mieter-Hotline bis zur automatisierten Objekt-Akquise: Wir bauen produktionsreife KI-Lösungen, die Ihren Arbeitsalltag entlasten und Mieter sowie Eigentümer begeistern.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroHausverwaltung")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroHausverwaltung");
                                onCtaClick();
                            }}
                        >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-12 fade-in">
                        <div>
                            <div className="text-4xl md:text-5xl font-bold text-primary">15-20h</div>
                            <div className="text-sm text-muted-foreground mt-2">gespart pro Woche</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold text-primary">400%</div>

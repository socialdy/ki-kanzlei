...
interface HeroSteuerberaterProps {
    onCtaClick: () => void;
}

export const HeroSteuerberater = ({ onCtaClick }: HeroSteuerberaterProps) => {
    return (
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <div className="inline-block slide-up mt-8 md:mt-0">
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-medium">
                            Ihr österreichischer KI‑Partner für Steuerberater
                        </span>
                    </div>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight slide-up">
                        KI Lösungen für <span className="text-primary">Steuerberater</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto slide-up">
                        Von der automatisierten BMD/DATEV-Vorerfassung bis zum 24/7 KI-Mandantensupport: Wir bauen DSGVO-konforme KI-Lösungen, die Ihre Kanzlei profitabler machen.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroSteuerberater")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroSteuerberater");
                                onCtaClick();
                            }}
                        >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-12 fade-in">
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground mt-2">Büro-Aufwand</div>
                        </div>
                        <div>
                            <div className="text-4xl md:text-5xl font-bold text-primary">100%</div>
                            <div className="text-sm text-muted-foreground mt-2">BMD & DATEV ready</div>
                        </div>
                        <div className="col-span-2 md:col-span-1">
                            <div className="text-4xl md:text-5xl font-bold text-primary">24/7</div>
                            <div className="text-sm text-muted-foreground mt-2">KI-Klienten-Support</div>
                        </div>
                    </div>
                </div>
            </div>

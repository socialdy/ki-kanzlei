...
interface HeroHandwerkerProps {
    onCtaClick: () => void;
}

export const HeroHandwerker = ({ onCtaClick }: HeroHandwerkerProps) => {
    return (
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroHandwerker")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroHandwerker");
                                onCtaClick();
                            }}
                        >

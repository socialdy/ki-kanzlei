...
export const NavigationRechtsanwaelte = () => {
    ...
    const menuItems = [
        { label: "Engpässe", href: "/ki-loesungen-rechtsanwaelte#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-rechtsanwaelte#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-rechtsanwaelte#ueber-uns", hasDropdown: false },
        { label: "Mandanten", href: "/ki-loesungen-rechtsanwaelte#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-rechtsanwaelte#faq", hasDropdown: false },
    ];

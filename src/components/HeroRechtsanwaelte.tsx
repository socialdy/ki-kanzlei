...
interface HeroRechtsanwaelteProps {
    onCtaClick: () => void;
}

export const HeroRechtsanwaelte = ({ onCtaClick }: HeroRechtsanwaelteProps) => {
    return (
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <div className="inline-block slide-up mt-8 md:mt-0">
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-medium">
                            Ihr österreichischer KI‑Partner für Rechtsanwälte & Notare
                        </span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroRechtsanwaelte")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroRechtsanwaelte");
                                onCtaClick();
                            }}
                        >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-12 fade-in">
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground mt-2">Zeit gespart / Woche</div>
                        </div>
                        <div>
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <div className="text-4xl md:text-5xl font-bold text-primary">Präzise</div>
                            <div className="text-sm text-muted-foreground mt-2">Recherche & Analyse</div>
                        </div>
                    </div>
                </div>
            </div>

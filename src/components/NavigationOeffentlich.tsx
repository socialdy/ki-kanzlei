...
export const NavigationOeffentlich = () => {
    const [isMenuOpen, setIsMenuOpen] = useState(false);

    const location = useLocation();
    const menuItems = [
        { label: "Engpässe", href: "/ki-loesungen-oeffentliche-einrichtungen#probleme" },
        { label: "Lösungen", href: "/ki-loesungen-oeffentliche-einrichtungen#loesungen" },
        { label: "Über uns", href: "/ki-loesungen-oeffentliche-einrichtungen#ueber-uns" },
                ...
                <div className="px-8 py-3">
                    <div className="flex items-center justify-between gap-4 md:gap-6 lg:gap-8">
                        ...
                        <div className="hidden lg:flex items-center gap-2 xl:gap-8">
                            {menuItems.map((item) => (
                                <Link
                                    ...
                                    to={item.href}
                                    onClick={(e: any) => {
                                        trackLinkClick(item.label, "NavigationOeffentlich");
                        ...
                        <div className="hidden lg:flex items-center">
                            <Button size="lg" asChild onClick={() => trackCtaClick("Kostenloses Analysegespräch", "NavigationOeffentlich")}>
                                <a href="/ki-loesungen-oeffentliche-einrichtungen#contact">
                        ...
                        <div className="p-6">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="pt-4 mt-2 border-t border-gray-200">
                                    <Button size="lg" className="w-full" asChild onClick={() => trackCtaClick("Kostenloses Analysegespräch", "NavigationOeffentlichMobile")}>
                                        <a href="/ki-loesungen-oeffentliche-einrichtungen#contact">
                                            Kostenloses Analysegespräch
                                        </a>
                                    </Button>

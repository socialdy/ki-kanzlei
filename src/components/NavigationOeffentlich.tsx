...
export const NavigationOeffentlich = () => {
    ...
    const menuItems = [
        { label: "Herausforderungen", href: "/ki-loesungen-oeffentliche-einrichtungen#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-oeffentliche-einrichtungen#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-oeffentliche-einrichtungen#ueber-uns", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-oeffentliche-einrichtungen#faq", hasDropdown: false },
    ];

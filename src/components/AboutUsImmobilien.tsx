...
export const AboutUsImmobilien = () => {
    useScrollAnimation();
    return (
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto slide-up">
                        Die Köpfe hinter der Automatisierung
                    </p>
                </div>
                ...
                <div className="mb-20">
                    <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        <div className="group text-center slide-up">
                            ...
                            <div className="text-primary font-semibold mb-3">Strategie & Vision</div>
                            <p className="text-muted-foreground text-sm leading-relaxed">
                                Strategischer Kopf hinter der KI Kanzlei. Kennt die Hürden des Immobilienmarktes und entwickelt die Konzepte für maximale Effizienz-Steigerung.
                            </p>
                        </div>
                        ...
                        <div className="group text-center slide-up">
                            ...
                            <div className="text-primary font-semibold mb-3">Technische Umsetzung</div>
                            <p className="text-muted-foreground text-sm leading-relaxed">
                                Der Architekt hinter den KI-Agenten. Sorgt dafür, dass Ihre Automatisierungen stabil laufen und nahtlos in Ihren Makler-Alltag integriert werden.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <section id="timeline-section" className="section-spacing">
                    <div className="mx-auto max-w-6xl px-4 md:px-6 text-center">
                        ...
                        <p className="mt-4 text-lg text-foreground opacity-70 slide-up">Warum wir Makler automatisieren</p>
                    </div>
                        ...
                        <div className="relative">
                            ...
                            <div id="1" className="timeline-card relative py-12 lg:py-20">
                                <div className="w-full py-6 px-8 lg:py-8 lg:px-16 rounded-xl shadow-xl border transition-all duration-300 ease-out bg-primary border-primary lg:w-[calc(50%-60px)] lg:mr-auto flex flex-col items-center text-center lg:items-start lg:text-left">
                                    <h3 className="font-bold text-lg lg:text-xl xl:text-2xl mb-3 text-white">Das Momentum</h3>
                                    <p className="text-sm lg:text-base xl:text-lg opacity-80 text-white leading-relaxed">Wir sahen Immobilienmakler, die 70% ihrer Zeit mit Terminkoordination und Lead-Qualifizierung verbrachten. Zeit, die für echte Verhandlungen fehlte. Wir wussten: Das geht besser.</p>
                                </div>
                            ...
                            <div id="2" className="timeline-card relative py-12 lg:py-20">
                                <div className="w-full py-6 px-8 lg:py-8 lg:px-16 rounded-xl shadow-xl border transition-all duration-300 ease-out bg-white border-border lg:w-[calc(50%-60px)] lg:ml-auto flex flex-col items-center text-center lg:items-start lg:text-left">
                                    <h3 className="font-bold text-lg lg:text-xl xl:text-2xl mb-3 text-foreground">Die Transformation</h3>
                                    <p className="text-sm lg:text-base xl:text-lg opacity-80 text-foreground leading-relaxed">Wir kombinierten unsere Erfahrung aus der Psychotherapie- und Hotelbranche mit dem Know-how über Immobilienportale. Das Ergebnis: KI-Agenten, die spezialisiert auf Kaufinteressenten reagieren.</p>
                                </div>
                            ...
                            <div id="3" className="timeline-card relative py-12 lg:py-20">
                                <div className="w-full py-6 px-8 lg:py-8 lg:px-16 rounded-xl shadow-xl border transition-all duration-300 ease-out bg-white border-border lg:w-[calc(50%-60px)] lg:mr-auto flex flex-col items-center text-center lg:items-start lg:text-left">
                                    ...
                                    <p className="text-sm lg:text-base xl:text-lg opacity-80 text-foreground leading-relaxed">Heute unterstützen wir Makler bei der kompletten Automatisierung ihres Lead-Funnels. Von der ersten Anfrage bis zur Schlüsselübergabe – KI begleitet den Prozess und sorgt für Rekord-ROIs.</p>
                                </div>
                                <div className="timeline-center-point hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full items-center justify-center shadow-md transition-colors duration-300 ease-out bg-white text-foreground border border-border">

...
export const NavigationAutohaus = () => {
    ...
    const menuItems = [
        { label: "Probleme", href: "/ki-loesungen-autohaus#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-autohaus#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-autohaus#ueber-uns", hasDropdown: false },
        { label: "Referenzen", href: "/ki-loesungen-autohaus#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-autohaus#faq", hasDropdown: false },
    ];

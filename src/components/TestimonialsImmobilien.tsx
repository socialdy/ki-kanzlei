...
export const TestimonialsImmobilien = () => {
    const testimonials = [
        ...
        },
        {
            ...
            hotel: "Urban Living Graz",
            location: "Graz",
            rating: 5.0,
            review: "Früher habe ich Stunden damit verbracht, auf willhaben-Anfragen zu antworten. Die KI-Lösung qualifiziert Interessenten jetzt vor und schickt direkt das Exposé. Das spart mir jeden Tag mindestens 3 Stunden Admin-Arbeit.",
            image: "https://randomuser.me/api/portraits/women/15.jpg",
        },
        {
            name: "Dr. Stefan Gruber",
            position: "Geschäftsführer",
            hotel: "Gruber & Partner",
            location: "Wien",
            rating: 5.0,
            review: "Die KI-Wissensdatenbank ist genial für Besichtigungen vor Ort. Per Voice-Chat frage ich Details zum Sanierungsstand oder zur Widmung ab und erhalte sofort die richtige Antwort aus hunderten PDFs. Das wirkt extrem professionell.",

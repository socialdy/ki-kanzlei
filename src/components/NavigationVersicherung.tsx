...
export const NavigationVersicherung = () => {
    ...
    const menuItems = [
        { label: "Engpässe", href: "/ki-loesungen-versicherungsmakler#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-versicherungsmakler#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-versicherungsmakler#ueber-uns", hasDropdown: false },
        { label: "Referenzen", href: "/ki-loesungen-versicherungsmakler#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-versicherungsmakler#faq", hasDropdown: false },
    ];

...
export const TestimonialsHotels = () => {
  const testimonials = [
    ...
    },
    {
      ...
      position: "Inhaberin",
      hotel: "Altstadt Hotel Schneider",
      location: "Salzburg",
      rating: 5.0,

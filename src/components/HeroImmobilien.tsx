...
interface HeroImmobilienProps {
    onCtaClick: () => void;
}

export const HeroImmobilien = ({ onCtaClick }: HeroImmobilienProps) => {
    return (
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <div className="inline-block slide-up mt-8 md:mt-0">
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-medium">
                            Ihr österreichischer KI‑Partner für Immobilienmakler
                        </span>
                    </div>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight slide-up break-words">
                        KI Lösungen für <span className="text-primary">Immobilienmakler</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto slide-up">
                        Von der 24/7 Lead-Qualifizierung bis zur automatisierten Besichtigungsterminen: Wir bauen produktionsreife KI-Lösungen, die Ihre Zeit für den Abschluss maximieren.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 slide-up">
                        <Button
                            ...
                            asChild
                            onClick={() => trackCtaClick("Analysegespräch", "HeroImmobilien")}
                        >
                            <a href="#contact">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                trackCtaClick("Whitepaper sichern", "HeroImmobilien");
                                onCtaClick();
                            }}
                        >

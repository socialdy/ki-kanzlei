...
export const NavigationHotels = () => {
  ...
  const menuItems = [
    ...
    { label: "Über uns", href: "/ki-loesungen-hotels#ueber-uns" },
        ...
        <div className="px-8 py-3">
          <div className="flex items-center justify-between gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="hidden lg:flex items-center">
              <Button size="lg" asChild onClick={() => trackCtaClick("Kostenloses Analysegespräch", "NavigationHotels")}>
            ...
            <div className="p-6">
              <div className="flex flex-col gap-1">
                ...
                <div className="pt-4 mt-2 border-t border-gray-200">
                  <Button size="lg" className="w-full" asChild onClick={() => trackCtaClick("Kostenloses Analysegespräch", "NavigationHotelsMobile")}>
                    <a href="/ki-loesungen-hotels#contact">
                      Kostenloses Analysegespräch
                    </a>
                  </Button>

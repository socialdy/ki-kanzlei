            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto slide-up">
                        Wir machen KI für E‑Commerce profitabel – DSGVO-konform und skalierbar
                    </p>
                </div>
                ...
                <section id="timeline-section" className="section-spacing">
                    <div className="mx-auto max-w-6xl px-4 md:px-6 text-center">
                        <h2 className="text-balance text-3xl font-bold md:text-4xl lg:text-5xl text-foreground mb-4 slide-up">Unsere Geschichte</h2>
                        <p className="mt-4 text-lg text-foreground opacity-70 slide-up">Wie wir den Onlinehandel smarter machen</p>
                    </div>
                        ...
                        <div className="relative">
                            ...
                            <div id="3" className="timeline-card relative py-12 lg:py-20">
                                <div className="w-full py-6 px-8 lg:py-8 lg:px-16 rounded-xl shadow-xl border transition-all duration-300 ease-out bg-white border-border lg:w-[calc(50%-60px)] lg:mr-auto flex flex-col items-center text-center lg:items-start lg:text-left">
                                    <h3 className="font-bold text-lg lg:text-xl xl:text-2xl mb-3 text-foreground">Vom Empfang zum E‑Commerce</h3>
                                    <p className="text-sm lg:text-base xl:text-lg opacity-80 text-foreground leading-relaxed">Wir erkannten schnell: Die Logik hinter effizienter Verwaltung lässt sich perfekt auf den Onlinehandel übertragen. Heute automatisieren wir Kundensupport und Bestellabwicklung für E-Commerce-Brands – skalierbar und hocheffizient.</p>
                                </div>
                                <div className="timeline-center-point hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full items-center justify-center shadow-md transition-colors duration-300 ease-out bg-white text-foreground border border-border">

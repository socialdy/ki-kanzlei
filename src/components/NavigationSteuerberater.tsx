...
export const NavigationSteuerberater = () => {
    ...
    const menuItems = [
        { label: "Engpässe", href: "/ki-loesungen-steuerberater#probleme", hasDropdown: false },
        { label: "Lösungen", href: "/ki-loesungen-steuerberater#loesungen", hasDropdown: false },
        { label: "Über uns", href: "/ki-loesungen-steuerberater#ueber-uns", hasDropdown: false },
        { label: "Klienten", href: "/ki-loesungen-steuerberater#referenzen", hasDropdown: false },
        { label: "FAQ", href: "/ki-loesungen-steuerberater#faq", hasDropdown: false },
    ];

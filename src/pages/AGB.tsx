...
const AGB = () => {
  useEffect(() => {
    document.title = "AGB | KI Kanzlei – KI-Automatisierung für Unternehmen";
    ...
    metaDescription.setAttribute('content', 'Allgemeine Geschäftsbedingungen der KI Kanzlei – AGB für B2B-Leistungen im Bereich KI-gestützter Prozessautomatisierung. Stand: März 2026.');
  }, []);
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-border p-8 md:p-12">
            ...
            <div className="space-y-8 text-gray-700 slide-up text-center">
              <div className="max-w-3xl mx-auto">
                ...
                {/* § 2 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 2 Leistungsgegenstand und Leistungsmodelle</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 3 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 3 Mitwirkungspflichten des Auftraggebers</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 4 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 4 Termine und Fristen</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 6 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 6 Abnahme</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 7 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 7 Gewährleistung</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 8 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 8 KI-spezifische Bestimmungen und EU AI Act</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 9 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 9 Haftungsbeschränkung</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 10 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 10 Geistiges Eigentum und Nutzungsrechte</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 11 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 11 Vertraulichkeit</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 12 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 12 Datenschutz und DSGVO</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 13 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 13 Höhere Gewalt</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 14 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 14 Laufzeit und Kündigung</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 15 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 15 Schlussbestimmungen</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 16 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 16 Preisanpassung</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 17 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 17 Abwerbeverbot und Treuepflichten</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 18 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 18 Ergänzende Haftungs- und Verfahrensbestimmungen</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                {/* § 19 */}
                <div className="text-left space-y-4 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">§ 19 Support und Fehlerklassen (Retainer-Verträge)</h2>
                  <p className="text-gray-600 leading-relaxed">
                  ...
                  <ul className="list-none text-gray-600 space-y-3 ml-4">
